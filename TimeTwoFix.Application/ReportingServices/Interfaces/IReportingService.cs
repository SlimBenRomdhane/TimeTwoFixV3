...
namespace TimeTwoFix.Application.ReportingServices.Interfaces
{
    public interface IReportingService
    {
        ...
        Task<IEnumerable<PauseAnalysisTrendDto>> GetPauseAnalysisTrendAsync(DateTime from, DateTime to);
        Task<IEnumerable<MechanicPerformanceTrendDto>> GetMechanicPerformanceTrendAsync(DateTime from, DateTime to);
    }
}
